...
int main()
{
    double t_arresto = 13120;
    long seed = 123456789;
    FILE *file = fopen("0.txt", "w+");
    ...
    for (int i = 0; i < 1000; i++) //numero di replicazioni
    {
...
// long seed = 123456789;
// FILE *file = fopen("1024Lost.txt", "w+"); //"2048Lost.txt", "w+"); //"4096Lost.txt", "w+"); //"8192Lost.txt", "w+"); //"16384Lost.txt", "w+"); //"32768Lost.txt", "w+"); //"65536Lost.txt", "w+"); //"131072Lost.txt", "w+");
